...
//        int minW = 0, minB = 0, secW = 0, secB = 0;
//
////////////////////////////////////////////////////
//// Introducing Classes
//
...
//    Font fontNumber;
//
//    if (!fontNumber.loadFromFile("The Vicious Circle.ttf")) {
//        std::cerr << "Error loading font" << std::endl;
//    }
//
//    // Setting text
...
//    Text timeWhite;
//
//    timeWhite.setFont(fontNumber);
//    timeWhite.setCharacterSize(70);
//    timeWhite.setPosition(80, 150);
//    timeWhite.setFillColor(Color::White);
//
//    Text timeBlack;
//
//    timeBlack.setFont(fontNumber);
//    timeBlack.setCharacterSize(70);
//    timeBlack.setPosition(1270, 700);
//    timeBlack.setFillColor(Color::Black);
//
//    Clock clock;
//    Time totalTime = seconds(600);
//    int remainingWhite = totalTime.asSeconds();
//    int remainingBlack = totalTime.asSeconds();
//    int min = 0;
//    int sec = 0;
//
...
//        if (turn == 0) {
//            remainingWhite = totalTime.asSeconds() - (elapsedTime.asSeconds() - (totalTime.asSeconds() - remainingBlack));
//            if (remainingWhite >= 0) {
//                minW = remainingWhite / 60;
//                secW = remainingWhite - (minW * 60);
//            }
//            if (minW < 10 && secW < 10) {
//                timeString = to_string(0) + to_string(minW) + ":0" + to_string(secW);
//            }
//            else if (minW < 10) {
//                timeString = to_string(0) + to_string(minW) + ":" + to_string(secW);
//            }
//            else if (secW < 10) {
//                timeString = to_string(minW) + ":0" + to_string(secW);
//            }
//            else {
//                timeString = to_string(minW) + ":" + to_string(secW);
//            }
//
//            timeWhite.setString(timeString);
//
//        } else if (turn == 1) {
//            remainingBlack = totalTime.asSeconds() - (elapsedTime.asSeconds() - (totalTime.asSeconds() - remainingWhite));
//            if (remainingBlack > 0) {
//                minB = remainingBlack / 60;
//                secB = remainingBlack - (minB * 60);
//            }
//            if (minB < 10 && secB < 10) {
//                timeString = to_string(0) + to_string(minB) + ":0" + to_string(secB);
//            }
//            else if (minB < 10) {
//                timeString = to_string(0) + to_string(minB) + ":" + to_string(secB);
//            }
//            else if (secB < 10) {
//                timeString = to_string(minB) + ":0" + to_string(secB);
//            }
//            else {
//                timeString = to_string(minB) + ":" + to_string(secB);
//            }
//            timeBlack.setString(timeString);
//        }
//
//       
//        
//        if (mate != 0) {
//            victoryBlack.setString("BLack Wins by TimeOut");
//        }
//        else {
...
//
//        if (mate != 1) {
//            victoryWhite.setString("White Wins by TimeOut");
//        }
//        else {
//            victoryWhite.setString("White Wins by CheckMate");
//        }
...
//
//        // Drawing objects
//        newWindow.draw(timeBlack);
//        newWindow.draw(timeWhite);
